...
export interface ApiObjectifObjectif extends Schema.CollectionType {
  ...
  attributes: {
    titre: Attribute.String & Attribute.Required & Attribute.DefaultTo<'titre'>;
    details: Attribute.Text &
      Attribute.Required &
      Attribute.DefaultTo<"description de l'objectif">;
    icon: Attribute.Enumeration<['school', 'training', 'event', 'fede']> &
      Attribute.Required &
      Attribute.DefaultTo<'fede'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
